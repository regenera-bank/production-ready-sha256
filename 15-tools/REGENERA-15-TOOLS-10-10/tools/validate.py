...
required = ["README.md", "Makefile", "release.json", "governance/CONTROL-MATRIX.json", "governance/TOOL-REGISTRY.json", "src/regenera_tools/cli.py", "src/regenera_tools/executor.py", "src/regenera_tools/release.py", "tests/test_executor.py", "tools/verify_release.py"]
errors: list[str] = []
for rel in required:
