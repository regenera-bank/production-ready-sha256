# Política de release dos canais

**Documento:** CH-POL-REL-001  
...
Garantir que somente artefato rastreável, testado e reversível avance entre ambientes.
...
- versão imutável e manifesto;
- testes por plataforma;
- aprovação segregada;
- hash externo e assinatura;
- rollback com critério de aborto;
